    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='book_managment.faculties')),
                ('gender_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_managment.genders')),
                ('role_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_managment.roles')),
            ],
        ),
        migrations.CreateModel(
            name='Depositories',
            fields=[
                ...
                ('copy_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='book_managment.copies')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_managment.users')),
            ],
        ),
    ]
